...
import { mountReplay, unmountReplay } from './replayWrapper.jsx';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const gardensWatchReplayButton = document.getElementById('gardens-watch-replay-button');
    ...
    let playerTurn = true;
    let gardensReplayData = { rounds: [], winner: null, finalPlayerSize: 0, finalEnemySize: 0, playerAvatar: '', nyanwolfAvatar: '' };
    ...
    function startGardensGame() {
        ...
        gardensReplayData = { 
            ...
            finalPlayerSize: 0, 
            finalEnemySize: 0,
            playerAvatar: document.getElementById('player-garden-avatar').src,
            nyanwolfAvatar: document.getElementById('nyanwolf-garden-avatar').src
        };

        setupGardenAvatars().then(() => {
            // Update avatars in replay data after setup
            gardensReplayData.playerAvatar = document.getElementById('player-garden-avatar').src;
            gardensReplayData.nyanwolfAvatar = document.getElementById('nyanwolf-garden-avatar').src;
        });
    ...
    function handleWatering() {
        ...
        // Record Round Data BEFORE updating size
        gardensReplayData.rounds.push({
            turn: 'player',
            roundNumber: gardensRound,
            growth: growth,
            prevPlayerSize: playerCarrotSize,
            prevEnemySize: nyanwolfCarrotSize
        });
    ...
    function endGardensGame() {
        ...
        gardensReplayData.finalPlayerSize = playerCarrotSize;
        gardensReplayData.finalEnemySize = nyanwolfCarrotSize;
        gardensReplayData.winner = (playerCarrotSize > nyanwolfCarrotSize) ? 'player' : (nyanwolfCarrotSize > playerCarrotSize ? 'enemy' : 'draw');
    }
